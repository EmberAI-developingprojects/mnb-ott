...
export function UpgradePrompt({ kind, vodId, channelId, price, title, backdrop }: Props) {
  /* lang нь KIND_TEXT object-ийн lang index болон template literal-руу шууд орох
     зөвхөн хоёр газар хэрэгтэй — UI string-ууд dict-руу */
    ...
    <>
      ...
      {qpay && (
        <div role="dialog"
          ...
          className="fixed inset-0 z-50 overlay-bg backdrop-blur-sm flex items-center justify-center p-4 animate-fade-in"
          ...
          <div className="surface-base rounded-2xl p-6 w-full max-w-sm space-y-5 shadow-pop animate-scale-in"
            ...
            <div className="flex items-center justify-between">
              <h2 id="qpay-modal-title" className="text-lg font-bold text-app">
                {t("qpay_title")}
              </h2>
